...
import io.suboptimal.netty.webtransport.WebTransportServerConnectionHandler;
...
public final class EchoServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        WebTransportServerConnectionHandler wtHandler =
                WebTransportServerConnectionHandler.builder()
                        .sessionHandlerFactory(EchoSessionHandler::new)
                        .initialMaxStreamsBidi(100)
                        .initialMaxStreamsUni(100)
                        .initialMaxData(1_048_576)
                        .build();

        io.netty.handler.codec.quic.QuicServerCodecBuilder quicCodec =
